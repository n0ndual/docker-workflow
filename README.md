...
##### 下一步工作计划：
由于时间有限，我们这一次的工作主要是手动配置服务，使各个微服务能够找到与自己位置最近的副本。接下去的工作，我们希望部署在GPN上的各个微服务能够自动寻找到延迟最低的其他微服务。由于Kubernetes使用了SkyDNS，而docker swarm也打算在之后的版本引入DNS，因此我们考虑通过编写一个DNS
插件，来完成这个功能。
